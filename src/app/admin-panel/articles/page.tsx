...
import {getArticlesPaginationInfo, ArticlesTable} from "@/entities/articles";
...
export default async function ArticlesPage(props: {
    ...
    const {totalPages, totalItems} = await getArticlesPaginationInfo(currentPageParam, PAGE_SIZE, query);
